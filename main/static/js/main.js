...
angry_playlist = ["ACDC-BackinBlack", "OhTheLarceny-ManonaMission", "LedZeppelin-ImmigrantSong" , "Shiv_Tandav_Strotam"];
angry_title = ["ACDC - Back in Black", "Oh The Larceny - Man on a Mission", "Led Zeppelin - Immigrant Song" , "Shiv_Tandav_Strotam"];
angry_poster = ["static/song_imgs/back_in_black.jpg", "static/song_imgs/man_on_a_mission.jpg", "static/song_imgs/immigrant_song.jpg", "static/song_imgs/Shiv_Tandav_Strotam.webp"];

happy_playlist = ["Tu_Meri" , "matargashti" , "Happier" , "Gallan_goodiya" , "Befikra"];
happy_title = ["Tu Meri" , "Matargashti" , "Happier" , "Gallan Goodiyan" , "Befikra"];
happy_poster = ["static/song_imgs/Tu_Meri.jpg"  , "static/song_imgs/matargashti.jpg" , "static/song_imgs/Happier.png" , "static/song_imgs/Gallan_goodiya.png" , "static/song_imgs/Befikra.png"];

calm_playlist = ["SmashMouth-AllStar" , "BillieEilish-BadGuy" , "Khwaja_mere_khwaja" , "Main_rahoon_ya_na_rahoon" , "Namo_Namo" , "Deva_Deva"];
calm_title = ["SmashMouth-AllStar" , "BillieEilish-BadGuy" , "Khwaja mere khwaja" , "Main rahoon ya na rahoon" , "Namo Namo" , "Deva Deva"];
calm_poster = ["static/song_imgs/all_star.jpeg" , "static/song_imgs/bad_guy.jpg" , "static/song_imgs/Khwaja_mere_khwaja.png" , "static/song_imgs/Mai_rahoon_ya_na_rahoon.png"  , "static/song_imgs/Namo_Namo.png" , "static/song_imgs/Deva_Deva.png"];

sad_playlist = ["CelineDion-MyHeartWillGoOn", "GaryJules-MadWorld" , "naina" , "Kun_faya" , "Agar_tum_sath_ho"];
sad_title = ["Celine Dion - My Heart Will Go On", "Gary Jules - Mad World" , "naina" , "Kun Faya" , "Agar Tum Sath Ho"];
sad_poster = ["static/song_imgs/my_heart_will_go_on.jpg", "static/song_imgs/mad_world.jpg" , "static/song_imgs/naina.png" , "static/song_imgs/Kun_faya.png" , "static/song_imgs/Agar_tum_sath_ho.png"];
